...
class Stage17TailPosition(Base):
    ...
    our_prob_entry: Mapped[float | None] = mapped_column(Float, nullable=True)
    koef_entry: Mapped[float | None] = mapped_column(Float, nullable=True)
    days_to_resolution_entry: Mapped[float | None] = mapped_column(Float, nullable=True)
