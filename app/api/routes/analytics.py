...
from app.api.routes.analytics_stage7 import register_stage7_routes
from app.api.routes.analytics_stage6 import register_stage6_routes
...
register_stage9_routes(router, cached_heavy_get=_cached_heavy_get)
register_stage8_routes(router, cached_heavy_get=_cached_heavy_get)
register_stage7_routes(router, cached_heavy_get=_cached_heavy_get)
register_stage6_routes(router, cached_heavy_get=_cached_heavy_get)
